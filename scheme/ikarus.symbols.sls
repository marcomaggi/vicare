...
(library (ikarus.symbols)
  (export
    ...
    system-value	system-value-gensym	SYSTEM-VALUE-GENSYM)
...
(define-constant SYSTEM-VALUE-GENSYM
  ...
  ;;value.
  ;;
  ;;This value  is not  part of the  public API:  it is not  exported by  the library
  ;;"(vicare)".  However,  it is  needed by the  initialisation library  generated by
