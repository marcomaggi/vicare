...
;;
;;Notice that  the high-level  Assembly instruction BSWAP!   is implemented  with the
;;Intel Assembly instruction BSWAP, which does *not* act on byte operands: as used by
