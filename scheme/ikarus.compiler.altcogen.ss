...
(module (alt-cogen.flatten-codes)
  ...
  ;;
  ;;Each block of  assembly code must have a way  to report errors; this
  ;;is  done by  appending at  the end  of the  main assembly  routine a
  ;;sequence of subroutines each handling a kind of error:
  ;;
  ;;  main_label:
