...

#!vicare
(library (ikarus.compiler.core-primitive-properties.compnums)
  (export initialise-core-primitive-properties/compnums)
  (import (rnrs)
  ...
  (define (initialise-core-primitive-properties/compnums)
