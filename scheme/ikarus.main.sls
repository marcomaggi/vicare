...
;;; Vicare options with argument
	  ...
	  ((%option= "--option")
	   (if (null? (cdr args))
		 ...
		 (("debug")
		  (option.debug-mode-enabled? #t)
		  (next-option (cddr args) (lambda () (k) (compiler.generate-debug-calls #t))))
		 (("no-debug")
		  (option.debug-mode-enabled? #f)
		  (next-option (cddr args) (lambda () (k) (compiler.generate-debug-calls #f))))
		 ...
		 (("drop-assertions")
		  (next-option (cddr args) (lambda () (k) (option.drop-assertions? #t))))
		 (("no-drop-assertions")
		  (next-option (cddr args) (lambda () (k) (option.drop-assertions? #f))))

		 (("check-compiler-pass-preconditions")
		  (next-option (cddr args) (lambda () (k) (compiler.check-compiler-pass-preconditions #t))))
		 (("no-check-compiler-pass-preconditions")
		  (next-option (cddr args) (lambda () (k) (compiler.check-compiler-pass-preconditions #f))))

		 (("gc-integrity-checks")
		  (next-option (cddr args) (lambda () (k) (foreign-call "ikrt_enable_gc_integrity_checks"))))
		 (("no-gc-integrity-checks")
		  (next-option (cddr args) (lambda () (k) (foreign-call "ikrt_disable_gc_integrity_checks"))))

		 (("print-assembly")
		  (next-option (cddr args) (lambda () (k) (compiler.assembler-output #t))))
		 (("print-optimizer" "print-optimiser")
		  (next-option (cddr args) (lambda () (k) (compiler.optimizer-output #t))))
