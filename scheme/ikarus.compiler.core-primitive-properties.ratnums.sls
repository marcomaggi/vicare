...

#!vicare
(library (ikarus.compiler.core-primitive-properties.ratnums)
  (export initialise-core-primitive-properties/ratnums)
  (import (rnrs)
  ...
  (define (initialise-core-primitive-properties/ratnums)
