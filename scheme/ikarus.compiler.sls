...
;;; --------------------------------------------------------------------
    ...
    ;;implement the  continuation function  generated by  CALL/CC.  Upon
    ...
    ((public-function		sl-continuation-code-label)
     ...
     (assembly
      ...
      ;;the highest machine word in the current Scheme stack segment.
      (subl (int wordsize) ebx)
      ;;If the current frame pointer is at the base of the stack (FPR ==
      ;;pcb->stack_base): we do not need  to do something for the return
      ;;values.
      (cmpl ebx fpr)
