...
(library (ikarus.compiler)
  (export
    ...
    (rename
     ...
     (optimize-letrec				$compiler.optimize-letrec)
     (source-optimize				$compiler.source-optimize)
     (rewrite-references-and-assignments	$compiler.rewrite-references-and-assignments)
     (introduce-tags				$compiler.introduce-tags)
     (introduce-vars				$compiler.introduce-vars)
     (sanitize-bindings				$compiler.sanitize-bindings)
     (optimize-for-direct-jumps			$compiler.optimize-for-direct-jumps)
     (insert-global-assignments			$compiler.insert-global-assignments)
     (convert-closures				$compiler.convert-closures)
     (optimize-closures/lift-codes		$compiler.optimize-closures/lift-codes)
     ...
     (alt-cogen.insert-stack-overflow-check	$alt-cogen.insert-stack-overflow-check)
     (alt-cogen.specify-representation		$alt-cogen.specify-representation)
