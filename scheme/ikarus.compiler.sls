...
;;; --------------------------------------------------------------------
    ...
    ;;implement the  continuation escape function generated  by CALL/CC;
    ;;it is the entry point associated to the closure object returned by
    ;;the primitive operation $FRAME->CONTINUATION.
    ;;
