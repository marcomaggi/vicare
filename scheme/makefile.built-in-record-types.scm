...
(define-built-in-record-type <object-type-spec>
  ...
  (methods
   ...
   (methods-table-public		object-type-spec.methods-table-public)
   (methods-table-protected		object-type-spec.methods-table-protected)
   (methods-table-private		object-type-spec.methods-table-private)
