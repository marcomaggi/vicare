...
;;; POSIX functions
    ...
    (strerror					v $language $posix $old-posix)
    (errno->string				$posix $old-posix)
    (getenv					v $language $posix $old-posix)
    (environ					v $language $posix $old-posix)
    (mkdir					$posix $old-posix)
    (mkdir/parents				$posix $old-posix)
    (real-pathname				$posix $old-posix)
    (file-pathname?				$posix $old-posix)
    (file-string-pathname?			$posix $old-posix)
    (file-bytevector-pathname?			$posix $old-posix)
    (file-absolute-pathname?			$posix $old-posix)
    (file-relative-pathname?			$posix $old-posix)
    (file-string-absolute-pathname?		$posix $old-posix)
    (file-string-relative-pathname?		$posix $old-posix)
    (file-bytevector-absolute-pathname?		$posix $old-posix)
    (file-bytevector-relative-pathname?		$posix $old-posix)
    (file-colon-search-path?			$posix $old-posix)
    (file-string-colon-search-path?		$posix $old-posix)
    (file-bytevector-colon-search-path?		$posix $old-posix)
    (list-of-pathnames?				$posix $old-posix)
    (list-of-string-pathnames?			$posix $old-posix)
    (list-of-bytevector-pathnames?		$posix $old-posix)
    (file-modification-time			$posix $old-posix)
    (split-pathname-root-and-tail		$posix $old-posix)
    (search-file-in-environment-path		$posix $old-posix)
    (search-file-in-list-path			$posix $old-posix)
    (split-pathname				$posix $old-posix)
    (split-pathname-bytevector			$posix $old-posix)
    (split-pathname-string			$posix $old-posix)
    (split-search-path				$posix $old-posix)
    (split-search-path-bytevector		$posix $old-posix)
    (split-search-path-string			$posix $old-posix)
    (vicare-argv0				v $language $posix $old-posix)
    (vicare-argv0-string			v $language $posix $old-posix)
