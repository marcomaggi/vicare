...
;;;
    ...
    (tagged-values-formals-syntax?		$type-specs)
    ...
    (parse-tagged-values-formals-syntax		$type-specs)
    (lambda-tagging-signature?			$type-specs)
    (values-tagging-signature?			$type-specs)
    ...
    (object-type-spec-pred-id			$type-specs)
    ...
    (identifier-object-type-spec-accessor	$type-specs)
    (identifier-object-type-spec-mutator	$type-specs)
    (object-type-spec-call-dispatcher		$type-specs)
    ...
    (identifier-with-tagging?			$type-specs)
    (set-identifier-type-tagging!		$type-specs)
    (identifier-type-tagging			$type-specs)
    (set-label-type-tagging!			$type-specs)
    (label-type-tagging				$type-specs)

    (set-identifier-function-signature!		$type-specs)
    (identifier-function-signature		$type-specs)
    (set-label-function-signature!		$type-specs)
    (label-function-signature			$type-specs)
