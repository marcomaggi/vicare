...
(define ikarus-system-macros
  '((define				(define))
    ...
    (record-type-unsafe-set!		(core-macro . record-type-unsafe-set!))
    (record-type-unsafe-ref		(core-macro . record-type-unsafe-ref))
...
;;
    ...
    (record-type-unsafe-set!			i v $language)
    (record-type-unsafe-ref			i v $language)
    (sealed					i v r rs)
