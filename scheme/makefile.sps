...
;;; Ikarus POSIX functions
    ...
    (accept-connection-nonblocking		i v posix)
    (close-tcp-server-socket			i v posix)
    (tcp-connect				i v posix)
    (tcp-connect-nonblocking			i v posix)
    (tcp-server-socket				i v posix)
    (tcp-server-socket-nonblocking		i v posix)
    (udp-connect				i v posix)
    (udp-connect-nonblocking			i v posix)
