...
;;; object type descriptors
    ...
    (<enumeration-type-descr>			v $language)
    (make-enumeration-type-descr		v $language)
    (enumeration-type-descr?			v $language)
    (enumeration-type-descr.symbol*		v $language)
    (enumeration-type-descr.length		v $language)
;;;
