...
;;;
    ...
    (make-return-values-signature		$type-specs)
    (return-values-signature?			$type-specs)
    (return-values-signature-tags		$type-specs)
    (false-or-return-values-signature?		$type-specs)
