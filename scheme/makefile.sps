...
;;;Core macros that can appear only in an expression.
    ,@(process-core-macros
	 ...
	 (type-descriptor-ancestry-super-and-sub? (core-macro . type-descriptor-ancestry-super-and-sub?))
	 (type-descriptor-matching-super-and-sub? (core-macro . type-descriptor-matching-super-and-sub?))
...
(define-constant IDENTIFIER->LIBRARY-MAP
  ...
  '((import					v $language)
    ...
    (type-descriptor-ancestry-super-and-sub?	v $language)
    (type-descriptor-matching-super-and-sub?	v $language)
...
;;;
    ...
    (object-type-descr.ancestry-super-and-sub?	$type-descriptors)
