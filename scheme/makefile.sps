...
;;;
    ($system-structs	(vicare system structs)			#t	#f)
...
;;; structs stuff
    ...
    (define-struct				v $language $system-structs)
    (struct?					v $language $system-structs)
    (struct-and-std?				v $language $system-structs)
    (make-struct-type				v $language $system-structs)
    (struct-type-descriptor?			v $language $system-structs)
    (struct-type-name				v $language $system-structs)
    (struct-type-symbol				v $language $system-structs)
    (struct-type-field-names			v $language $system-structs)
    (struct-type-destructor			v $language $system-structs)
    (set-struct-type-printer!			v $language $system-structs)
    (set-rtd-printer!				v $language $system-structs)
    (struct-type-printer			v $language $system-structs)
    (set-struct-type-destructor!		v $language $system-structs)
    (set-rtd-destructor!			v $language $system-structs)
    (struct-constructor				v $language $system-structs)
    (struct-predicate				v $language $system-structs)
    (struct-field-accessor			v $language $system-structs)
    (struct-field-mutator			v $language $system-structs)
    (struct-field-method			v $language $system-structs)
    (struct-length				v $language $system-structs)
    (struct-field-names				v $language $system-structs)
    (struct-ref					v $language $system-structs)
    (struct-set!				v $language $system-structs)
    (struct-and-std-ref				v $language $system-structs)
    (struct-and-std-set!			v $language $system-structs)
    (struct-printer				v $language $system-structs)
    (struct-destructor				v $language $system-structs)
    (struct-name				v $language $system-structs)
    (struct-std					v $language $system-structs)
    (struct-rtd					v $language $system-structs)
    (struct=?					v $language $system-structs)
    (struct-reset				v $language $system-structs)
    (struct-guardian-logger			v $language $system-structs)
    (struct-guardian-log			v $language $system-structs)
    (struct-hash				v $language $system-structs)
...
;;;
    ...
    (code-set!					$code-objects)
    (set-code-reloc-vector!			$code-objects)
    (set-code-annotation!			$code-objects)
...
;;; --------------------------------------------------------------------
    ...
    (core-type-descriptor.implemented-interfaces $type-descriptors)
    (core-type-descriptor=?			$type-descriptors)
...
;;; configuration options
    ...
    (print-verbose-messages?				$options)
    (print-debug-messages?				$options)
    (print-library-debug-messages?			$options)
    (print-loaded-libraries?				$options)
    (debug-mode-enabled?				$options)
    (drop-assertions?					$options)
    ...
    (vicare-built-with-ffi-enabled			$options)
    (vicare-built-with-iconv-enabled			$options)
    (vicare-built-with-posix-enabled			$options)
    (vicare-built-with-glibc-enabled			$options)
    (vicare-built-with-linux-enabled			$options)
