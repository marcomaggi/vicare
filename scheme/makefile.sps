...
;;; --------------------------------------------------------------------
    ...
    ($compiler.optimize-letrec				$compiler)
    ($compiler.source-optimize				$compiler)
    ($compiler.rewrite-references-and-assignments	$compiler)
    ($compiler.introduce-tags				$compiler)
    ($compiler.introduce-vars				$compiler)
    ($compiler.sanitize-bindings			$compiler)
    ($compiler.optimize-for-direct-jumps		$compiler)
    ($compiler.insert-global-assignments		$compiler)
    ($compiler.convert-closures				$compiler)
    ($compiler.optimize-closures/lift-codes		$compiler)
