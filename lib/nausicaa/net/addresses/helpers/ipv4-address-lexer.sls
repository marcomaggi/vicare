#!r6rs
(library (nausicaa net addresses helpers ipv4-address-lexer)
  (export
...
;
; Table generated from the file ../../lib/nausicaa/net/addresses/helpers/ipv4-address-lexer.l by SILex 1.0
;
