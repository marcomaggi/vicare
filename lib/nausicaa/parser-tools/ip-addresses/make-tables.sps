...
(lex.lex (lex.input-file:	(%prefix "ipv6-address-lexer.l"))
	 ...
	 (lex.library-spec:	'(nausicaa parser-tools ip-addresses ipv6-address-lexer))
...
(lex.lex (lex.input-file:	(%prefix "ipv4-address-lexer.l"))
	 ...
	 (lex.library-spec:	'(nausicaa parser-tools ip-addresses ipv4-address-lexer))
	 (lex.library-language:	'(nausicaa))
	 (lex.library-imports:	'((nausicaa parser-tools silex default-error-handler)
				  (prefix (nausicaa parser-tools lexical-tokens) lt.)
				  (prefix (nausicaa parser-tools source-locations) sl.)))
...
(lalr.lalr-parser
 ...
 (lalr.library-spec:		'(nausicaa parser-tools ip-addresses ipv4-address-parser))
...
(lalr.lalr-parser
 ...
 (lalr.library-spec:		'(nausicaa parser-tools ip-addresses ipv6-address-parser))
