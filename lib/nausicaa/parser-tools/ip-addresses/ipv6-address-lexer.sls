#!r6rs
(library (nausicaa parser-tools ip-addresses ipv6-address-lexer)
  (export
...
;
; Table generated from the file ../../lib/nausicaa/parser-tools/ip-addresses//ipv6-address-lexer.l by SILex 1.0
;
