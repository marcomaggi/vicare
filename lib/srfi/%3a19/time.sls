...
(define (tm:current-time-thread)
  (assertion-violation 'current-time-thread "thread time not implemented"))

(define (tm:current-time-process)
  (assertion-violation 'current-time-process "process time not implemented"))

(define (tm:current-time-gc)
  (assertion-violation 'current-time-gc "GC time not implemented"))
