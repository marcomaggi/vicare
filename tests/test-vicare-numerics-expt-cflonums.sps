...
(check-display "*** testing Vicare numerics functions: expt, cflonum exponent\n")
...
(parametrise ((check-test-name	'fixnum-base))
  ...
  (define-syntax test
    (make-inexact-test expt $expt-number-cflonum $expt-fixnum-cflonum))

  (test 0	+1.0+2.0i	0)
  (test +1	+1.0+2.0i	1.0)
  (test -1	+1.0+2.0i	-0.0018674427317079893+2.286882234649021e-19i)
  (test +2	+1.0+2.0i	0.36691394948660344+1.9660554808224875i)
  (test -2	+1.0+2.0i	-6.851907881310297e-4-0.0036714960177966108i)
...
(parametrise ((check-test-name	'ratnum-base))
  ...
  (define-syntax test
    (make-inexact-test expt $expt-number-cflonum $expt-ratnum-cflonum))

  (test 1/2	+1.0+2.0i	0.09172848737165086-0.4915138702056219i)
  (test -1/2	+1.0+2.0i	-1.7129769703275736e-4+9.178740044491525e-4i)
...
(parametrise ((check-test-name	'flonum-base))
  ...
  (define-syntax test
    (make-inexact-test expt $expt-number-cflonum $expt-flonum-cflonum))

  (test	+0.0		+1.0+2.0i	0.0)
  (test	-0.0		+1.0+2.0i	-0.0)
  (test	+1.0		+1.0+2.0i	1.0+0.0i)
  (test	-1.0		+1.0+2.0i	-0.0018674427317079893+2.286882234649021e-19i)
  (test	+nan.0		+1.0+2.0i	+nan.0+nan.0i)
  (test	+inf.0		+1.0+2.0i	+nan.0+nan.0i)
  (test	-inf.0		+1.0+2.0i	+nan.0+nan.0i)
  (test +2.0		+1.0+2.0i	0.36691394948660344+1.9660554808224875i)
  (test -2.0		+1.0+2.0i	-6.851907881310297e-4-0.0036714960177966108i)
...
(parametrise ((check-test-name	'cflonum-base))
  ...
  (define-syntax test
    (make-inexact-test expt $expt-number-cflonum $expt-cflonum-cflonum))

  (test	+0.0+0.0i	+1.0+2.0i	+0.0+0.0i)
  (test	-0.0+0.0i	+1.0+2.0i	+0.0+0.0i)
  (test	+0.0-0.0i	+1.0+2.0i	+0.0+0.0i)
  (test	-0.0-0.0i	+1.0+2.0i	+0.0+0.0i)
  (test	+nan.0+2.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	+1.0+nan.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	+nan.0+nan.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	+inf.0+2.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	+1.0+inf.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	+inf.0+inf.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	-inf.0+2.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	+1.0-inf.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	-inf.0-inf.0i	+1.0+2.0i	+nan.0+nan.0i)
  (test	+1.0+2.0i	+1.0+2.0i	-0.22251715680177267+0.10070913113607541i)

  (catch-implementation-restriction
   "undefined result"
   (expt +0.0+0.0i -1.0+2.0i))
...
(parametrise ((check-test-name	'compnum-base))
  ...
  (define-syntax test
    (make-inexact-test expt $expt-number-cflonum $expt-compnum-cflonum))

  (test	+1+2i		+1.0+2.0i	-0.22251715680177267+0.10070913113607541i)
