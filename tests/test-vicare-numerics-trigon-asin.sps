...
(parametrise ((check-test-name	'fixnums))
  ...
  (case-word-size
   ...
   ((64)
    (test (greatest-fixnum)	+1.5707963267948966-42.281978014156664i)
    (test (least-fixnum)	-1.5707963267948966+42.281978014156664i)))
...
(parametrise ((check-test-name	'bignums))
  ...
  (let-syntax ((test (syntax-rules ()
		       ((_ ?op ?expected)
			(check (asin ?op)		(=> inexact=?) ?expected)))))
    (test BN1 +1.5707963267948966-20.79441541679836i)
    (test BN2 +1.5707963267948966-20.79441560120021i)
    (test BN3 -1.5707963267948966+20.794415418661004i)
    (test BN4 -1.5707963267948966+20.794415603062856i))

  (test VBN1 1.5707963267948966-42.281978014156664i)
  (test VBN2 1.5707963267948966-42.281978014156664i)
  (test VBN3 -1.5707963267948966+42.281978014156664i)
  (test VBN4 -1.5707963267948966+42.281978014156664i)
