...
(library (types-of-lists)
  ...
  (import (vicare)
    (prefix (vicare expander) expander::))
  (define-syntax <list-of-fixnums>	(expander::make-typed-list-type-spec #'<fixnum>))
  (define-syntax <list-of-flonums>	(expander::make-typed-list-type-spec #'<flonum>))
  (define-syntax <list-of-numbers>	(expander::make-typed-list-type-spec #'<number>))
  (define-syntax <list-of-reals>	(expander::make-typed-list-type-spec #'<real>))
  (define-syntax <list-of-strings>	(expander::make-typed-list-type-spec #'<string>))
  (define-syntax <vector-of-fixnums>	(expander::make-typed-vector-type-spec #'<fixnum>))
  (define-syntax <vector-of-flonums>	(expander::make-typed-vector-type-spec #'<flonum>))
  (define-syntax <vector-of-numbers>	(expander::make-typed-vector-type-spec #'<number>))
  (define-syntax <vector-of-reals>	(expander::make-typed-vector-type-spec #'<real>))
  (define-syntax <vector-of-strings>	(expander::make-typed-vector-type-spec #'<string>))
  #| end of LIBRARY |# )
