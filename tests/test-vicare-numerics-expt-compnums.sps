...
(parametrise ((check-test-name	'bignum-base))
  ...
  (case-word-size
   ...
   ((64)
    (test BN1	+1+2i	8.586340858174443e16+1.1497197357841759e18i)
    (test BN2	+1+2i	8.586340858174443e16+1.1497197357841759e18i)
    (test BN3	+1+2i	-1.603449982756447e14-2.14703576409139e15i)
    (test BN4	+1+2i	-1.603449982756447e14-2.14703576409139e15i)))
