...
(parametrise ((check-test-name	'fixnums))
  ...
  (case-word-size
   ...
   ((64)
    (test (greatest-fixnum)	+42.281978014156664i)
    (test (least-fixnum)	3.141592653589793-42.281978014156664i)))
...
(parametrise ((check-test-name	'bignums))
  ...
  (let-syntax ((test (syntax-rules ()
		       ((_ ?op ?expected)
			(check (acos ?op)		(=> inexact=?) ?expected)))))
    (test BN1 +20.794415418661004i)
    (test BN2 +20.79441543542481i)
    (test BN3 3.141592653589793-20.79441542052365i)
    (test BN4 3.141592653589793-20.794415437287455i)
    #| end of LET-SYNTAX |# )

  (test VBN1 +42.281978014156664i)
  (test VBN2 +42.281978014156664i)
  (test VBN3 3.14159265358979-42.28197801415666i)
  (test VBN4 3.14159265358979-42.28197801415666i)
...
(parametrise ((check-test-name	'ratnums))
  ...
  (test (/ BN1 123) +15.982231063288573i)
  (test (/ BN2 123) +15.98223108005238i)
