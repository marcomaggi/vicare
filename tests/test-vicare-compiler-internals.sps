...
;;; libraries
  ...
  (libdoit* (library (recordize-demo-2)
	    ...
	    (rec*bind
		((lex.a-parent-rtd_0	(constant #f))
		 (lex.a-rtd_0		(funcall (primref make-record-type-descriptor)
					  (constant a) lex.a-parent-rtd_0 (constant #f)
					  (constant #f) (constant #f) (constant #())))
		 (lex.a-constructor-protocol_0 (constant #f))
		 (lex.a-rcd_0		(funcall (primref make-record-constructor-descriptor)
					  lex.a-rtd_0 (constant #f)
					  lex.a-constructor-protocol_0))
		 (lex.destroy-a_0	(constant #f))
		 (lex.a?_0		(funcall (primref record-predicate) lex.a-rtd_0))
		 (lex.make-a_0		(funcall (primref record-constructor) lex.a-rcd_0))
		 (lex.a-first-field-offset_0 (funcall (primref $struct-ref) lex.a-rtd_0 (constant 3))))
	      (constant #!void)))
...
;;; libraries
  ...
  (check
	...
	(let* ((form1 '(library (optimize-letrec-scc-demo-2)
	       ...
	       (form2 (%expand-library form1)))
	  (%optimize-letrec form2)))
    => '(bind ((lex.a-parent-rtd_0 (constant #f)))
	  (bind ((lex.a-rtd_0 (funcall (primref make-record-type-descriptor)
				(constant a) lex.a-parent-rtd_0 (constant #f)
				(constant #f) (constant #f) (constant #()))))
	    (bind ((lex.a-constructor-protocol_0 (constant #f)))
	      (bind ((lex.a-rcd_0
			...
			lex.a-rtd_0 (constant #f)
			lex.a-constructor-protocol_0)))
		(bind ((lex.destroy-a_0 (constant #f)))
		  (bind ((lex.a?_0 (funcall (primref record-predicate) lex.a-rtd_0)))
		    (bind ((lex.make-a_0 (funcall (primref record-constructor) lex.a-rcd_0)))
		      (bind ((lex.a-first-field-offset_0 (funcall (primref $struct-ref) lex.a-rtd_0 (constant 3))))
			(constant #!void))))))))))
