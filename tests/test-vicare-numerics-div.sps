...
(parametrise ((check-test-name	'bignums))
  ...
  (let-syntax ((test (make-test / $div-bignum-compnum)))
    ...
    (test BN1 1.0+20.0i 1338830.204488778-26776604.089775562i)
    (test BN1 10.0+2.0i 51622203.07692308-10324440.615384616i)
...
(parametrise ((check-test-name	'flonums))
  ...
  (let-syntax ((test (make-test / $div-flonum-fixnum)))
    (test FL1 FX1 0.0)
    (test FL2 FX1 -0.0)
    (test FL3 FX1 2.123)
    (test FL4 FX1 -2.123)
...
(parametrise ((check-test-name	'compnums))
  ...
  (letrec-syntax ((test (make-test / $div-compnum-fixnum)))
  ...
  (letrec-syntax ((test (make-test / $div-compnum-cflonum)))
