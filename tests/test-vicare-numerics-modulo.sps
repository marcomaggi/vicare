...
(parametrise ((check-test-name	'fixnums))
  ...
  (let-syntax ((test (make-flonum-test modulo $modulo-fixnum-flonum)))
    (test FX1 FL3 0.0)
    (test FX2 FL3 0.0)
    (test FX3 FL3 0.0)
    (test FX4 FL3 0.0)
...
(parametrise ((check-test-name	'bignums))
  ...
  (let-syntax ((test (make-test modulo $modulo-bignum-fixnum)))
    ...
    (test BN2 FX1 0)
    (test BN3 FX1 0)
    (test BN3 FX1 (r6rs-modulo BN3 FX1))
    (test BN4 FX1 0)
    (test BN1 FX2 0)
    (test BN2 FX2 0)
    (test BN3 FX2 0)
    ...
    (test BN1 FX3 1)
    (test BN2 FX3 100)
    (test BN3 FX3 536870909)
    (test BN4 FX3 536870810)
    (test BN1 FX4 0)
    (test BN1 FX4 (r6rs-modulo BN1 FX4))
    (test BN2 FX4 -536870813)
    (test BN3 FX4 -1)
    (test BN4 FX4 -100)
    #f)
  ...
  (let-syntax ((test (make-test modulo $modulo-bignum-bignum)))
    (test BN1 BN1 0)
    (test BN2 BN1 99)
    (test BN3 BN1 536870911)
    (test BN4 BN1 536870812)
    (test BN1 BN2 536870912)
    (test BN2 BN2 0)
    (test BN3 BN2 98)
    (test BN4 BN2 536871010)
    (test BN1 BN3 -1)
    (test BN2 BN3 -536870815)
    (test BN3 BN3 0)
    (test BN4 BN3 -99)
    (test BN1 BN4 -100)
    (test BN2 BN4 -1)
...
(parametrise ((check-test-name	'flonums))
  ...
  (let-syntax ((test (make-inexact-test modulo $modulo-flonum-fixnum)))
    ...
    (test FL2 FX3 0.0)
    (test FL3 FX3 1.0)
    (test FL4 FX3 536870910.0)
    (test FL5 FX3 2.0)
    (test FL6 FX3 536870909.0)
    (test FL1 FX4 0.0)
    (test FL2 FX4 0.0)
    (test FL3 FX4 -536870911.0)
    (test FL4 FX4 -1.0)
    (test FL5 FX4 -536870910.0)
    (test FL6 FX4 -2.0)
    #f)
  ...
  (let-syntax ((test (make-inexact-test modulo $modulo-flonum-bignum)))
    ...
    (test FL2 BN1 0.0)
    (test FL3 BN1 1.0)
    (test FL4 BN1 536870911.0)
    (test FL5 BN1 2.0)
    (test FL6 BN1 536870910.0)
    (test FL1 BN2 0.0)
    (test FL2 BN2 0.0)
    (test FL3 BN2 1.0)
    (test FL4 BN2 536871010.0)
    (test FL5 BN2 2.0)
    (test FL6 BN2 536871009.0)
    (test FL1 BN3 0.0)
    (test FL2 BN3 0.0)
    (test FL3 BN3 -536870912.0)
    (test FL4 BN3 -1.0)
    (test FL5 BN3 -536870911.0)
    (test FL6 BN3 -2.0)
    (test FL1 BN4 0.0)
    (test FL2 BN4 0.0)
    (test FL3 BN4 -536871011.0)
    (test FL4 BN4 -1.0)
    (test FL5 BN4 -536871010.0)
    (test FL6 BN4 -2.0)
    #f)

  (let-syntax ((test (make-flonum-test modulo $modulo-flonum-flonum)))
    (test 25.0 10.0 5.0)
    (test 10.0 25.0 10.0)
    (test FL1 FL3 0.0)
    (test FL2 FL3 0.0)
