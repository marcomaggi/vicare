...
(parametrise ((check-test-name	'fixnums))
  ...
  (let-syntax ((test (make-flonum-test quotient $quotient-fixnum-flonum)))
    (test FX1 FL3 1.0)
    (test FX2 FL3 -1.0)
    ...
    (test FX1 FL5 0.0)
    (test FX2 FL5 -0.0)
    (test FX3 FL5 268435455.0)
    (test FX4 FL5 -268435456.0)
    (test FX1 FL6 -0.0)
    (test FX2 FL6 0.0)
    (test FX3 FL6 -268435455.0)
    (test FX4 FL6 268435456.0)
    #f)
...
(parametrise ((check-test-name	'bignums))
  ...
  (let-syntax ((test (make-inexact-test quotient $quotient-bignum-flonum)))
    ...
    (test BN1 FL5 268435456.0)
    (test BN2 FL5 268435505.0)
    (test BN3 FL5 -268435456.0)
    (test BN4 FL5 -268435506.0)
    (test BN1 FL6 -268435456.0)
    (test BN2 FL6 -268435505.0)
    (test BN3 FL6 268435456.0)
    (test BN4 FL6 268435506.0)
    #f)
...
(parametrise ((check-test-name	'flonums))
  ...
  (let-syntax ((test (make-flonum-test quotient $quotient-flonum-flonum)))
    (test 25.0 10.0 2.0)
    (test 10.0 25.0 0.0)
    (test FL1 FL3 0.0)
    (test FL2 FL3 -0.0)
