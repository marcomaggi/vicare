...
(parametrise ((check-test-name	'compnums))
  ...
  (letrec-syntax ((test1 (make-test * $mul-compnum-fixnum))
		  (test (syntax-rules ()
			  ((_ ?op1 ?op2)
  ...
  (letrec-syntax ((test1 (make-test * $mul-compnum-bignum))
		  (test (syntax-rules ()
			  ((_ ?op1 ?op2)
			   (test1 ?op1 ?op2 (C (- (R ?op1) (R ?op2))
					       (- (I ?op1) (I ?op2))))))))
  ...
  (letrec-syntax ((test1 (make-test * $mul-compnum-ratnum))
		  (test (syntax-rules ()
			  ((_ ?op1 ?op2)
			   (test1 ?op1 ?op2 (C (- (R ?op1) (R ?op2))
					       (- (I ?op1) (I ?op2))))))))
  ...
  (letrec-syntax ((test1 (make-test * $mul-compnum-flonum))
		  (test (syntax-rules ()
			  ((_ ?op1 ?op2)
			   (test1 ?op1 ?op2 (C (- (R ?op1) (R ?op2))
					       (- (I ?op1) (I ?op2))))))))
  ...
  (letrec-syntax ((test1 (make-test * $mul-compnum-cflonum))
		  (test (syntax-rules ()
			  ((_ ?op1 ?op2)
			   (test1 ?op1 ?op2 (C (- (R ?op1) (R ?op2))
					       (- (I ?op1) (I ?op2))))))))
