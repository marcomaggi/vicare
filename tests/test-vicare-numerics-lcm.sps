...
(parametrise ((check-test-name	'fixnums))
  ...
  (let-syntax ((test (make-flonum-test lcm $lcm-fixnum-flonum)))
    ...
    (test FX1 FL3 1.0)
    (test FX2 FL3 1.0)
    (test FX3 FL3 536870911.0)
    (test FX4 FL3 536870912.0)
    (test FX1 FL4 1.0)
    (test FX2 FL4 1.0)
    (test FX3 FL4 536870911.0)
    (test FX4 FL4 536870912.0)
    (test FX1 FL5 2.0)
    (test FX2 FL5 2.0)
    (test FX3 FL5 1073741822.0)
    (test FX4 FL5 536870912.0)
    (test FX1 FL6 2.0)
    (test FX2 FL6 2.0)
    (test FX3 FL6 1073741822.0)
    (test FX4 FL6 536870912.0)
    #f)
...
(parametrise ((check-test-name	'bignums))
  ...
  (let-syntax ((test (make-inexact-test lcm $lcm-bignum-flonum)))
    ...
    (test BN3 FL2 0.0)
    (test BN4 FL2 0.0)
    (test BN1 FL3 536870912.0)
    (test BN2 FL3 536871011.0)
    (test BN3 FL3 536870913.0)
    (test BN4 FL3 536871012.0)
    (test BN1 FL4 536870912.0)
    (test BN2 FL4 536871011.0)
    (test BN3 FL4 536870913.0)
    (test BN4 FL4 536871012.0)
    (test BN1 FL5 536870912.0)
    (test BN2 FL5 1073742022.0)
    (test BN3 FL5 1073741826.0)
    (test BN4 FL5 536871012.0)
    (test BN1 FL6 536870912.0)
    (test BN2 FL6 1073742022.0)
    (test BN3 FL6 1073741826.0)
    (test BN4 FL6 536871012.0)
    #f)
...
(parametrise ((check-test-name	'flonums))
  ...
  (let-syntax ((test (make-inexact-test lcm $lcm-flonum-fixnum)))
    ...
    (test FL1 FX3 0.0)
    (test FL2 FX3 0.0)
    (test FL3 FX3 536870911.0)
    (test FL4 FX3 536870911.0)
    (test FL5 FX3 1073741822.0)
    (test FL6 FX3 1073741822.0)
    (test FL1 FX4 0.0)
    (test FL2 FX4 0.0)
    (test FL3 FX4 536870912.0)
    (test FL4 FX4 536870912.0)
    (test FL5 FX4 536870912.0)
    (test FL6 FX4 536870912.0)
    #f)

  (let-syntax ((test (make-inexact-test lcm $lcm-flonum-bignum)))
    (test FL1 BN1 0.0)
    (test FL2 BN1 0.0)
    (test FL3 BN1 536870912.0)
    (test FL4 BN1 536870912.0)
    (test FL5 BN1 536870912.0)
    (test FL6 BN1 536870912.0)
    (test FL1 BN2 0.0)
    (test FL2 BN2 0.0)
    (test FL3 BN2 536871011.0)
    (test FL4 BN2 536871011.0)
    (test FL5 BN2 1073742022.0)
    (test FL6 BN2 1073742022.0)
    (test FL1 BN3 0.0)
    (test FL2 BN3 0.0)
    (test FL3 BN3 536870913.0)
    (test FL4 BN3 536870913.0)
    (test FL5 BN3 1073741826.0)
    (test FL6 BN3 1073741826.0)
    (test FL1 BN4 0.0)
    (test FL2 BN4 0.0)
    (test FL3 BN4 536871012.0)
    (test FL4 BN4 536871012.0)
    (test FL5 BN4 536871012.0)
    (test FL6 BN4 536871012.0)
    #f)
