...
(letrec-syntax
  ...
  (declare stats-user-secs	<non-negative-exact-integer>)
  (declare stats-user-usecs	<non-negative-exact-integer>)
  (declare stats-sys-secs	<non-negative-exact-integer>)
  (declare stats-sys-usecs	<non-negative-exact-integer>)
  (declare stats-real-secs	<non-negative-exact-integer>)
  (declare stats-real-usecs	<non-negative-exact-integer>)
  (declare stats-gc-user-secs	<non-negative-exact-integer>)
  (declare stats-gc-user-usecs	<non-negative-exact-integer>)
  (declare stats-gc-sys-secs	<non-negative-exact-integer>)
  (declare stats-gc-sys-usecs	<non-negative-exact-integer>)
  (declare stats-gc-real-secs	<non-negative-exact-integer>)
  (declare stats-gc-real-usecs	<non-negative-exact-integer>)
  (declare stats-bytes-minor	<non-negative-exact-integer>)
  (declare stats-bytes-major	<non-negative-exact-integer>)
  #| end of LET-SYNTAX |# )
