...
** Whenever a conditional:
   ...
   (if (type? ?var) ?conseq ?altern)

   is found, the ?conseq should be processed with an augmented environment in
   which the VAR struct ?var is known to have type "T:type".
