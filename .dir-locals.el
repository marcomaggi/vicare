...
((vicare-mode
  . ((indent-tabs-mode . t)
     ...
     (eval . (put 'case-type-signature-structure*					'scheme-indent-function 1))
     (eval . (put 'case-type-predicate-syntax						'scheme-indent-function 2))
     ...
     (eval . (put 'cnd::define-core-condition-type					'scheme-indent-function 2))
     (eval . (put 'define-core-condition-type						'scheme-indent-function 2))
     (eval . (put 'define-core-record-type						'scheme-indent-function 1))
     ...
     ;;
     (eval . (put 'compound-condition-type-spec.exists					'scheme-indent-function 1))
     (eval . (put 'compound-condition-type-spec.for-all					'scheme-indent-function 1))
     (eval . (put 'union-type-spec.exists						'scheme-indent-function 1))
     (eval . (put 'union-type-spec.for-all						'scheme-indent-function 1))
     (eval . (put 'intersection-type-spec.exists					'scheme-indent-function 1))
     (eval . (put 'intersection-type-spec.for-all					'scheme-indent-function 1))
     (eval . (put 'list-type-spec.exists						'scheme-indent-function 1))
     (eval . (put 'list-type-spec.for-all						'scheme-indent-function 1))
     (eval . (put 'vector-type-spec.exists						'scheme-indent-function 1))
     (eval . (put 'vector-type-spec.for-all						'scheme-indent-function 1))
     (eval . (put 'ancestor-of-type-spec.exists						'scheme-indent-function 1))
     (eval . (put 'ancestor-of-type-spec.for-all					'scheme-indent-function 1))
     (eval . (put 'enumeration-type-spec.for-all					'scheme-indent-function 1))
     ))
 )
